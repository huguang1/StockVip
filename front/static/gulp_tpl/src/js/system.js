...
Auth.prototype.updatePasswordEvent = function () {
    var changePwdBtn = $("#change-pwd-btn");
    ...
    changePwdBtn.click(function () {
        ...
        // 表单验证
        if (!oldPwd) {
            layer.msg('请输入原始登录密码', {icon: 2, time: 1000});
            // return null;
        } else if (!newPwd || !newPwd2) {
            layer.msg('请输入新的登录密码', {icon: 2, time: 1000});
            // return null;
...
Auth.prototype.editUserEvent = function () {
    ...
    $(".edit-user-btn").click(function () {
        ...
        // var user_active = prt.prevAll('.td-status').attr('data-is');
        ...
        //     editUserDisableInput.attr("checked", "checked");
        //     editUserEnableInput.removeAttr("checked");
        //     $("#edit-status-radio > div:nth-child(1) > div").removeClass('checked');
        //     $("#edit-status-radio > div:nth-child(2) > div").addClass('checked');
        // }
        // // else {
        // //     $("#edit-status-radio > div:nth-child(2) > div").removeClass('checked');
        // //     $("#edit-status-radio > div:nth-child(1) > div").addClass('checked')
        // // }
    ...
    $("#edit-user-submit").click(function () {
        ...
        console.log(user_id, userDesc, user_type, activation);
